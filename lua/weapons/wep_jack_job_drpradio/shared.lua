...
elseif(CLIENT)then
	...
	function SWEP:DrawHUD()
		...
		draw.SimpleTextOutlined("Channel: "..ChanTxt,"Trebuchet24",W*.76,H*.87,Color(255,255,255,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER,1,Color(0,0,0,255))
	end
end
SWEP.Base="weapon_base"
SWEP.ViewModel = "models/weapons/v_eq_fraggrenade.mdl"
SWEP.WorldModel = "models/radio/w_radio.mdl"
SWEP.PrintName = "Personal Radio"
SWEP.Instructions	= ""
SWEP.Author			= ""
SWEP.Contact		= ""
SWEP.Purpose		= ""
...
if(CLIENT)then
	net.Receive("jackjob_drp_radiochannelmenu",function(len,ply)
		...
		DermaPanel:SetTitle("Select Channel")
